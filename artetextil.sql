...
--
-- Host: localhost:3306
-- Generation Time: Apr 15, 2015 at 04:49 PM
...
CREATE TABLE `sh_affiliate_transaction` (
...
CREATE TABLE `sh_attribute_description` (
  `attribute_id` int(11) NOT NULL,
...
CREATE TABLE `sh_attribute_group` (
`attribute_group_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
...
CREATE TABLE `sh_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_banner_image_description` (
  `banner_image_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `banner_id` int(11) NOT NULL,
...
CREATE TABLE `sh_category_description` (
  `category_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
CREATE TABLE `sh_category_filter` (
  `category_id` int(11) NOT NULL,
...
CREATE TABLE `sh_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
CREATE TABLE `sh_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_coupon_category` (
  `coupon_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_coupon_history` (
...
CREATE TABLE `sh_coupon_product` (
...
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.22149999, 0, '2015-04-15 16:48:26'),
(2, 'US Dollar', 'USD', '$', '', '2', 0.32890001, 1, '2015-04-15 16:48:26'),
(3, 'Euro', 'EUR', '', '€', '2', 0.30770001, 0, '2015-04-15 16:48:26'),
(4, 'Real (BR)', 'BRL', 'R$ ', '', '2', 1.00000000, 1, '2015-04-15 16:48:51');
...
CREATE TABLE `sh_customer_ban_ip` (
...
CREATE TABLE `sh_customer_field` (
  `customer_id` int(11) NOT NULL,
...
CREATE TABLE `sh_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
CREATE TABLE `sh_customer_history` (
...
CREATE TABLE `sh_customer_online` (
  `ip` varchar(40) NOT NULL,
  `customer_id` int(11) NOT NULL,
  `url` text NOT NULL,
...
('127.0.0.1', 0, 'http://lojaaretetextil.homolog.lojavirtual.digital/', '', '2015-04-15 16:48:57');
...
CREATE TABLE `sh_customer_reward` (
...
CREATE TABLE `sh_customer_transaction` (
...
CREATE TABLE `sh_custom_field_description` (
  `custom_field_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_custom_field_to_customer_group` (
  `custom_field_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_custom_field_value` (
`custom_field_value_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `sort_order` int(3) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_custom_field_value_description` (
  `custom_field_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `custom_field_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
CREATE TABLE `sh_download_description` (
  `download_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_filter_description` (
  `filter_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `filter_group_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
...
CREATE TABLE `sh_filter_group_description` (
  `filter_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_information_description` (
  `information_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(64) NOT NULL,
  `description` text NOT NULL
...
CREATE TABLE `sh_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_length_class_description` (
`length_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
...
CREATE TABLE `sh_manufacturer_to_store` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_option_description` (
  `option_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_option_value_description` (
  `option_value_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
  `name` varchar(128) NOT NULL
...
CREATE TABLE `sh_order_download` (
...
CREATE TABLE `sh_order_recurring` (
...
CREATE TABLE `sh_order_recurring_transaction` (
...
CREATE TABLE `sh_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `text` text NOT NULL
...
CREATE TABLE `sh_product_description` (
  `product_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `description` text NOT NULL,
...
CREATE TABLE `sh_product_discount` (
...
CREATE TABLE `sh_product_filter` (
  `product_id` int(11) NOT NULL,
  `filter_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_product_option` (
`product_option_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `option_id` int(11) NOT NULL,
...
CREATE TABLE `sh_product_option_value` (
...
CREATE TABLE `sh_product_profile` (
  `product_id` int(11) NOT NULL,
  `profile_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_product_recurring` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_product_related` (
  `product_id` int(11) NOT NULL,
...
CREATE TABLE `sh_product_reward` (
...
CREATE TABLE `sh_product_special` (
...
CREATE TABLE `sh_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_profile_description` (
  `profile_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_return_history` (
...
(13144, 0, 'config', 'config_image_cart_width', '60', 0),
(13145, 0, 'config', 'config_image_cart_height', '60', 0),
(13146, 0, 'config', 'config_ftp_host', 'artextil.net', 0),
(13147, 0, 'config', 'config_ftp_port', '21', 0),
(13148, 0, 'config', 'config_ftp_username', '', 0),
(13149, 0, 'config', 'config_ftp_password', '', 0),
(13150, 0, 'config', 'config_ftp_root', '', 0),
(13151, 0, 'config', 'config_ftp_status', '0', 0),
(13152, 0, 'config', 'config_mail_protocol', 'mail', 0),
(13153, 0, 'config', 'config_mail_parameter', '', 0),
(13154, 0, 'config', 'config_smtp_host', '', 0),
(13155, 0, 'config', 'config_smtp_username', '', 0),
(13156, 0, 'config', 'config_smtp_password', '', 0),
(13157, 0, 'config', 'config_smtp_port', '25', 0),
(13158, 0, 'config', 'config_smtp_timeout', '5', 0),
(13159, 0, 'config', 'config_alert_mail', '0', 0),
(13160, 0, 'config', 'config_account_mail', '0', 0),
(13161, 0, 'config', 'config_alert_emails', 'contato@isabellacarvallho.com\r\ncontato@artetextil.net\r\n\r\n\r\n', 0),
(13162, 0, 'config', 'config_fraud_detection', '0', 0),
(13163, 0, 'config', 'config_fraud_key', '', 0),
(13164, 0, 'config', 'config_fraud_score', '', 0),
(13165, 0, 'config', 'config_fraud_status_id', '7', 0),
(13166, 0, 'config', 'config_secure', '0', 0),
(13167, 0, 'config', 'config_shared', '0', 0),
(13168, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai''hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(13143, 0, 'config', 'config_image_wishlist_height', '50', 0),
(13142, 0, 'config', 'config_image_wishlist_width', '50', 0),
(13140, 0, 'config', 'config_image_compare_width', '80', 0),
(13141, 0, 'config', 'config_image_compare_height', '80', 0),
(13139, 0, 'config', 'config_image_related_height', '120', 0),
(13138, 0, 'config', 'config_image_related_width', '120', 0),
(13137, 0, 'config', 'config_image_additional_height', '62', 0),
(13135, 0, 'config', 'config_image_product_height', '160', 0),
(13136, 0, 'config', 'config_image_additional_width', '62', 0),
(13134, 0, 'config', 'config_image_product_width', '160', 0),
(13133, 0, 'config', 'config_image_popup_height', '900', 0),
(13132, 0, 'config', 'config_image_popup_width', '900', 0),
(13131, 0, 'config', 'config_image_thumb_height', '525', 0),
(13130, 0, 'config', 'config_image_thumb_width', '455', 0),
(13129, 0, 'config', 'config_image_category_height', '90', 0),
(13128, 0, 'config', 'config_image_category_width', '90', 0),
(13127, 0, 'config', 'config_icon', 'data/logotipo-arte.png', 0),
(13126, 0, 'config', 'config_logo', 'data/logotipo-arte.png', 0),
(13125, 0, 'config', 'config_return_status_id', '2', 0),
(13124, 0, 'config', 'config_return_id', '0', 0),
(13123, 0, 'config', 'config_commission', '5', 0),
(13122, 0, 'config', 'config_affiliate_id', '4', 0),
(13121, 0, 'config', 'config_stock_status_id', '5', 0),
(13120, 0, 'config', 'config_stock_checkout', '0', 0),
(13119, 0, 'config', 'config_stock_warning', '0', 0),
(13118, 0, 'config', 'config_stock_display', '0', 0),
(13117, 0, 'config', 'config_complete_status_id', '5', 0),
(13116, 0, 'config', 'config_order_status_id', '1', 0),
(13115, 0, 'config', 'config_invoice_prefix', 'INV-2013-00', 0),
(13114, 0, 'config', 'config_order_edit', '100', 0),
(13113, 0, 'config', 'config_checkout_id', '5', 0),
(13112, 0, 'config', 'config_guest_checkout', '1', 0),
(13111, 0, 'config', 'config_cart_weight', '1', 0),
(13110, 0, 'config', 'config_account_id', '3', 0),
(13109, 0, 'config', 'config_customer_price', '0', 0),
(13108, 0, 'config', 'config_customer_group_display', 'a:1:{i:0;s:1:"1";}', 1),
...
(13107, 0, 'config', 'config_customer_group_id', '1', 0),
...
(13106, 0, 'config', 'config_customer_online', '1', 0),
...
(13105, 0, 'config', 'config_tax_customer', 'shipping', 0),
(13104, 0, 'config', 'config_tax_default', 'shipping', 0),
(13103, 0, 'config', 'config_vat', '0', 0),
(13102, 0, 'config', 'config_tax', '1', 0),
(13101, 0, 'config', 'config_voucher_max', '1000', 0),
(13100, 0, 'config', 'config_voucher_min', '1', 0),
(13099, 0, 'config', 'config_download', '0', 0),
(13098, 0, 'config', 'config_review_status', '1', 0),
(13097, 0, 'config', 'config_product_count', '1', 0),
(13096, 0, 'config', 'config_admin_limit', '20', 0),
(13095, 0, 'config', 'config_catalog_limit', '10', 0),
(13094, 0, 'config', 'config_weight_class_id', '1', 0),
(13093, 0, 'config', 'config_length_class_id', '1', 0),
(13092, 0, 'config', 'config_currency_auto', '1', 0),
(13091, 0, 'config', 'config_currency', 'BRL', 0),
(13090, 0, 'config', 'config_admin_language', 'pt-br', 0),
(13089, 0, 'config', 'config_language', 'pt-br', 0),
(13088, 0, 'config', 'config_zone_id', '464', 0),
(13087, 0, 'config', 'config_country_id', '30', 0),
(13086, 0, 'config', 'config_layout_id', '2', 0),
(13085, 0, 'config', 'config_template', 'sellegance', 0),
(13084, 0, 'config', 'config_meta_description', 'Shop | Arte Têxtil\r\nLoja de tecidos, almofadas e criações do Atelier Arte Têxtil', 0),
(13083, 0, 'config', 'config_title', 'Shop | Arte Têxtil', 0),
(13081, 0, 'config', 'config_telephone', '(11) 2639-8208', 0),
(13082, 0, 'config', 'config_fax', '', 0),
...
(13080, 0, 'config', 'config_email', 'contato@artetextil.net', 0),
...
(13077, 0, 'config', 'config_name', 'Shop | Arte Têxtil', 0),
(13078, 0, 'config', 'config_owner', 'Arte Têxtil', 0),
(13079, 0, 'config', 'config_address', 'Rua Iperoig, 409 - Perdizes, São Paulo/SP\r\nCEP 05016-000 - Tel.: (11) 2639-8208 contato@isabellacarvalho.com\r\ncontato@artetextil.net\r\n\r\nwww.artetextil.net', 0),
(12674, 0, 'sellegance', 'sellegance_status', '1', 0),
(12675, 0, 'sellegance', 'sellegance_main_layout', 'large', 0),
(13169, 0, 'config', 'config_seo_url', '1', 0),
(13170, 0, 'config', 'config_file_extension_allowed', 'txt\r\npng\r\njpe\r\njpeg\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc\r\nrtf\r\nxls\r\nppt\r\nodt\r\nods', 0),
(13171, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/jpeg\r\nimage/jpeg\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/vnd.microsoft.icon\r\nimage/tiff\r\nimage/tiff\r\nimage/svg+xml\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-rar-compressed\r\napplication/x-msdownload\r\napplication/vnd.ms-cab-compressed\r\naudio/mpeg\r\nvideo/quicktime\r\nvideo/quicktime\r\napplication/pdf\r\nimage/vnd.adobe.photoshop\r\napplication/postscript\r\napplication/postscript\r\napplication/postscript\r\napplication/msword\r\napplication/rtf\r\napplication/vnd.ms-excel\r\napplication/vnd.ms-powerpoint\r\napplication/vnd.oasis.opendocument.text\r\napplication/vnd.oasis.opendocument.spreadsheet', 0),
(13172, 0, 'config', 'config_maintenance', '0', 0),
(13173, 0, 'config', 'config_password', '1', 0),
(13174, 0, 'config', 'config_encryption', 'b35e4f20b145ae61c4fbc47355fa293e', 0),
(13175, 0, 'config', 'config_compression', '0', 0),
(13176, 0, 'config', 'config_error_display', '1', 0),
(13177, 0, 'config', 'config_error_log', '1', 0),
(13178, 0, 'config', 'config_error_filename', 'error.txt', 0),
(13179, 0, 'config', 'config_google_analytics', '', 0);
...
CREATE TABLE `sh_tax_rate_to_customer_group` (
  `tax_rate_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
(6, 1, 'admin', 'c87b0d61936cc6985b3c38eb7a066ce9f9d057aa', '238f7ac56', '', '', 'fernando.mendes@webca.com.br', '', '127.0.0.1', 1, '2015-02-13 11:21:08');
...
CREATE TABLE `sh_voucher_history` (
...
CREATE TABLE `sh_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `sh_weight_class_description` (
`weight_class_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) NOT NULL,
  `unit` varchar(4) NOT NULL
...
CREATE TABLE `sh_zone_to_geo_zone` (
...
--
ALTER TABLE `sh_setting`
MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=13180;
--
