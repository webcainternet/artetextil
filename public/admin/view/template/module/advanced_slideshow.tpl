...
$caption_style = array (
	...
	'big_white'             => 'Big White',
	'big_orange'            => 'Big Orange',
	'big_black'             => 'Big Black',
	'very_big_white'        => 'Very Big White',
	'very_big_black'        => 'Very Big Black',
	'large_text'            => 'Large Text',
	'large_black_text'      => 'Large Black Text',
	'very_large_text'       => 'Very Large Text',
	'very_large_black_text' => 'Very Large Black Text',
	'bold_red_text'         => 'Bold Red Text',
	'bold_brown_text'       => 'Bold Brown Text',
	...
	<div class="content">
		...
		<div>
			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
				...
				<h2><?php echo $entry_general_settings_sub; ?></h2>
				...
				<table class="form">
						...
						<td>
							<select name="slider_main_layout">
								<?php foreach ($slider_layout as $fv => $fc) { ?>
									<?php ($fv ==  $this->config->get('slider_main_layout')) ? $current = 'selected' : $current='tabs'; ?>
					...
					<h2><?php echo $entry_slides_setup_sub; ?></h2>
					...
					<table class="form">
						<tr>
							...
							<td>
								...
								<?php } ?>
								</select> <span class="customhelp"><?php echo $entry_quantity_note; ?></span>
							</td>
						</tr>
									...
									<tr>
										...
										<td>
											<table>
												<tr>
													<td>
														<input type="hidden" name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][banner]" value="<?php echo $slider[$i][$language_id]['banner']; ?>" id="slider_<?php echo $i; ?>_<?php echo $language_id; ?>_banner" />
										...
										<td>
											<select name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][transition_effect]" >
												<?php foreach ($transition as $slv => $slc) { ?>
													<?php ($slv ==  $slider[$i][$language_id]['transition_effect']) ? $current = 'selected' : $current = ''; ?>
											...
											<td>
												<select name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][<?php echo $m; ?>][style]" >
													<?php foreach ($caption_style as $slv => $slc) { ?>
														<?php ($slv == $slider[$i][$language_id][$m]['style']) ? $current = 'selected' : $current = ''; ?>
														<option value="<?php echo $slv; ?>" <?php echo $current; ?> ><?php echo $slc; ?></option>
													<?php } ?>
												</select>
											</td>
											...
											<td>
												...
												<select name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][<?php echo $m; ?>][animation_in]" >
													<?php foreach ($animation_in as $slv => $slc) { ?>
														<?php ($slv == $slider[$i][$language_id][$m]['animation_in']) ? $current = 'selected' : $current = ''; ?>
														<option value="<?php echo $slv; ?>" <?php echo $current; ?> ><?php echo $slc; ?></option>	
													<?php } ?>
												</select>
												...
												<select name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][<?php echo $m; ?>][animation_out]" >
													<?php foreach ($animation_out as $slv => $slc) { ?>
														<?php ($slv == $slider[$i][$language_id][$m]['animation_out']) ? $current = 'selected' : $current = ''; ?>
														<option value="<?php echo $slv; ?>" <?php echo $current; ?> ><?php echo $slc; ?></option>	
													<?php } ?>
												</select>
											</td>
											...
											<td>
												...
												<select name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][<?php echo $m; ?>][easing]" >
													<?php foreach ($easing as $slv => $slc) { ?>
														<?php ($slv == $slider[$i][$language_id][$m]['easing']) ? $current = 'selected' : $current = ''; ?>
														<option value="<?php echo $slv; ?>" <?php echo $current; ?> ><?php echo $slc; ?></option>	
													<?php } ?>
												</select>
												...
												<select name="slider[<?php echo $i; ?>][<?php echo $language_id; ?>][<?php echo $m; ?>][endeasing]" >
													<?php foreach ($easing as $slv => $slc) { ?>
														<?php ($slv == $slider[$i][$language_id][$m]['endeasing']) ? $current = 'selected' : $current = ''; ?>
														<option value="<?php echo $slv; ?>" <?php echo $current; ?> ><?php echo $slc; ?></option>	
													<?php } ?>
												</select>
											</td>
