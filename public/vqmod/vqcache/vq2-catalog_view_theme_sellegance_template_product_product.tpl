					...
					<div class="col-sm-6">
						...
						<?php if ($thumb || $images) { ?>
							...
							<?php if ($thumb) { ?>
								...
								<?php if($this->config->get('sellegance_status') == 1 && $this->config->get('sellegance_cloud_zoom') == 1) { ?>

									<!-- image zoom  -->

									<a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="cloud-zoom" id='image' rel="adjustX: 10, adjustY:-4, tint:false,lensOpacity:0.2, zoomWidth:360, position:'<?php echo $this->config->get('sellegance_zoom_position'); ?>', showTitle:false"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" /></a><a href="<?php echo $popup; ?>"id="zoom-image" title=" <?php echo $heading_title; ?>" class="colorbox tooltp" rel="colorbox"><span><i class="icon-search"></i> <?php echo $this->language->get('text_zoom'); ?></span></a>
					...
					<div class="col-sm-6 rightcol">
						...
						<?php } ?>
							...
							<div class="more-actions">
								<span class="wishlist"><a onclick="addToWishList('<?php echo $product_id; ?>');" title="<?php echo $button_wishlist; ?>" class="tooltp" ><i class="icon-heart"></i> <?php echo $button_wishlist; ?></a></span>
						...
						<?php if ($review_status) { ?>
							...
							<div class="review">
								...
								<a id="add-review-link" onclick="$('a[href=\'#tab-review\']').trigger('click'); $('html, body').animate({scrollTop: $('#add-review').offset().top}, 800);" ><i class="icon-comment"></i> <?php echo $text_write; ?></a>
