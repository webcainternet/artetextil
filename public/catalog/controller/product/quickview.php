...
class ControllerProductQuickview extends Controller {
	...
	public function index() { 
		$this->language->load('product/quickview');
		...
		if ($product_info) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/product/quickview.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/product/quickview.tpl';
			} else {
				$this->template = 'default/template/product/quickview.tpl';
			}
