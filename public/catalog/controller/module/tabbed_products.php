...
class ControllerModuleTabbedProducts extends Controller {
	...
	protected function index($setting) {
		...
		$this->language->load('module/tabbed_products');
		...
		$this->data['latest_mode'] = $setting['latest'];
		$this->data['featured_mode'] = $setting['featured'];
		$this->data['bestseller_mode'] = $setting['bestseller'];
		$this->data['special_mode'] = $setting['special'];
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/module/tabbed_products.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/module/tabbed_products.tpl';
		} else {
			$this->template = 'default/template/module/tabbed_products.tpl';
		}
