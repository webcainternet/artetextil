<?php $this->language->load('module/sellegance'); ?>
	...
	<div id="quickViewContent">
		...
		<header class="page-header">
			...
			<a href="index.php?route=product/product&product_id=<?php echo $product_id; ?>" class="button button-default button-sm more-details"><?php echo $this->language->get('text_more_details'); ?> <i class="icon-caret-down"></i></a>
		</header>
