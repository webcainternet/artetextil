			...
			<div class="mainborder">
				...
				<div class="nav-container">
					...
					<div class="button-group nav-compare">
						...
						<button id="previous-column" class="button button-default button-sm">
							<?php echo $this->language->get('text_prev'); ?>
						</button>
						
						<button id="next-column" class="button button-default button-sm">
					...
					<table class="table table-adjust compare-info">
						...
						<tbody>
							<tr>
								<td></td>
								<?php foreach ($products as $product) { ?>
								<td><input type="button" value="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button button-cart button-sm" /></td>
								<?php } ?>
							</tr>
							<tr>
								<td></td>
