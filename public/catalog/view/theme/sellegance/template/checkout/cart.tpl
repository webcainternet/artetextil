				...
				<div class="cart-inner">
					...
					<div class="row">
								...
								<div class="cart-module">
									...
									<div id="coupon" class="content">
										<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form">
											...
											<input type="submit" value="<?php echo $button_coupon; ?>" class="button button-default button-sm" />
										</form>
									</div>
									...
									<div id="voucher" class="content">
										<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form">
											...
											<input type="submit" value="<?php echo $button_voucher; ?>" class="button button-default button-sm" />
										</form>
									</div>
									...
									<div id="reward" class="content">
										<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form">
											...
											<input type="submit" value="<?php echo $button_reward; ?>" class="button button-default button-sm" />
										</form>
									</div>
									...
									<div id="shipping" class="content form">
										...
										<input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button button-default button-sm" />
									</div>
						...
						<section id="total-cart" class="col-sm-6">
							...
							<div class="buttons">
								<span class="cart float-right"><a href="<?php echo $checkout; ?>" id="button-checkout" class="button"><?php echo $button_checkout; ?></a></span>
					...
					success: function(json) {
						...
						if (json['shipping_method']) {
							...
							<?php if ($shipping_method) { ?>
								html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="button button-default button-inverse button-sm" />';
							<?php } else { ?>
								html += '  <input type="submit" value="<?php echo $button_shipping; ?>" id="button-shipping" class="button button-default button-inverse button-sm" disabled="disabled" />';
							<?php } ?>
